...
namespace ArtWiz.View.Widgets
{
    public class OutlineTextBlock : Shape
    {
        ...
        private static void OnPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) => ((OutlineTextBlock)d).CreateTextGeometry();
        ...
        private void CreateTextGeometry()
        {
            var formattedText = new FormattedText(Text, Thread.CurrentThread.CurrentUICulture, FlowDirection.LeftToRight,
                                    new Typeface(FontFamily, FontStyle, FontWeight, FontStretch), FontSize, Brushes.Black, 1);
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            return new Size(Math.Min(availableSize.Width, _textGeometry.Bounds.Width),
                ...
                _textGeometry.Bounds.Bottom + _textGeometry.Bounds.Top));
        }
    }
}
