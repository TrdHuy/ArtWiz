...
namespace ArtWiz.Utils
{
    ...
    {
        public static double CalculateEuclideanDistance(this Color thisColor, Color otherColor)
        {
        ...
        public static Color BlendColors(this Color foreground, Color background)
        {
